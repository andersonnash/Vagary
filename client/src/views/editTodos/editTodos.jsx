    ...
    return (
        <Layout user={props.user}>
            <div className=" min-h-screen shadow-2xl px-8 pb-10 mb-4 font-serif pt-40  ">
                <h3 className=" flex  lg:flex lg:justify-center lg:items-center justify-center font-bold uppercase text-black text-2xl italic font-mono">Edit Trip</h3>
                <div>
                    <div className=" bg-gray-300 text-black flex justify-center rounded-lg mt-14 py-5 shadow-2xl md:mx-60 lg:mx-80 ">
                        <form onSubmit={handleSubmit} input={input}>
                            ...
                            <br />
                            <button className="bg-green-400 hover:bg-red-300  text-white text-xs  px-6 py-2 mt-6 mb-3 " type="submit">Update</button>
                        </form>
                    </div>
                </div>
            </div>
